...
const en = {
  ...
  contact: {
    ...
    hours: 'Saturday to Thursday, 9-11 PM',
...
const es: Dictionary = {
  ...
  contact: {
    ...
    errors: {
      ...
      submit: 'No pudimos enviar su solicitud. Inténtelo de nuevo o contáctenos directamente.',
    },
    infoTitle: 'Contáctenos directamente',
    hours: 'Sábado a jueves, 9-11 PM',
